...
const banner2 = cfonts.render((`Canal: https://youtube.com/@KAIZINHO-ZK\nDesenvolvedor Oficial: @DANIEL ZK`), {
font: 'console',
align: 'center',
gradient: ['red', 'magenta']
});
 
const banner3 = cfonts.render((`JINWOO-V2.3`), {
  font: 'block',
  align: "center",
  gradient: ['red', 'magenta']
});
...
const packname = "Criador: @Daniel zk"
